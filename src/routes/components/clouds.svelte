<script>
    ...
    onMount(() => {
        if ( WebGL.isWebGL2Available() === false ) {
            ...
            canvasContainer.appendChild( WebGL.getWebGL2ErrorMessage() );
        ...
        gradient.addColorStop( 0.0, '#f2faff' );
        gradient.addColorStop( 0.5, '#e1f0fa' );
...
<section bind:this={canvasContainer} id="canvas-container"></section>
